const icons = [
                    ...
                    "blank"
                     ...
                     at Icon (http"::"8081/index.bundle?platform=android&dev=true&minify=false&app=com.accuwheather&modulesOnly=false&runModule=true":"134221":38)
                     in Icon (created by CrossFadeIcon)
                     in RCTView (created by View)
                     in View (created by AnimatedComponent)
                     in AnimatedComponent
                     in AnimatedComponentWrapper (created by CrossFadeIcon)
                     in RCTView (created by View)
                     ...
                     in Appbar.Action (created by HomeScreen)
                     in RCTView (created by View)
                     ...
                     in Appbar.Header (created by AppHeader)
                     in AppHeader (created by HomeScreen)
                     in RCTView (created by View)
                     in View (created by HomeScreen)
                     in RCTView (created by View)
                     in View (created by HomeScreen)
                     ...
                     in View (created by AppContainer)
                     in AppContainer
                     in accuwheather(RootComponent)
                  BUNDLE  ./index.js
                 
                  LOG  Running"accuwheather""with"{
                    "rootTag":11
                 }"ERROR  Warning":"Failed prop type":"Invalid prop""`name`""of value""`udacity`""supplied to""`Icon`",
                 "expected one of"[
                    "ab-testing",
                    "abacus",
                    "abjad-arabic",
